...
## Project Structure
    ...
    ├── testapiautostorybo_106933  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_106933`
...
2. Clone this repo and `cd testapiautostorybo_106933`
